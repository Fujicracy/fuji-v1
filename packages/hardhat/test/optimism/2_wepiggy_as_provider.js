...
describe("Optimism Fuji Instance", function () {
  let evmSnapshot0;
  let evmSnapshot1;
  let evmSnapshot2;
  ...
  before(async function () {
    ...
    for (let x = 0; x < 4; x += 1) {
      await this.f.optimismUnwrapper.connect(this.users[x]).deposit({ value: parseUnits(500) });
  ...
  describe("WePiggy as Provider", function () {
    ...
    describe.only("Native token as collateral, ERC20 as borrow asset.", function () {
      testDeposit1(
