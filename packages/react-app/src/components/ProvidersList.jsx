        ...
        {markets && markets.includes('DAI') && (
          <div className="provider">
            ...
            <div className="stats">
              <div
                className={
                  get(providerAave, 'address') === activeProviderDai ? 'stat best' : 'stat'
                }
              >
              ...
              <div
                className={
                  get(providerCompound, 'address') === activeProviderDai ? 'stat best' : 'stat'
                }
              >
              ...
              <div
                className={
                  get(providerDYDX, 'address') === activeProviderDai ? 'stat best' : 'stat'
                }
              >
        ...
        {markets && markets.includes('USDC') && (
          <div className="provider">
            ...
            <div className="stats">
              <div
                className={
                  get(providerAave, 'address') === activeProviderUsdc ? 'stat best' : 'stat'
                }
              >
                <span className="name">Aave</span>
                <span className="number">
              ...
              <div
                className={
                  get(providerCompound, 'address') === activeProviderUsdc ? 'stat best' : 'stat'
                }
              >
                <span className="name">Compound</span>
                <span className="number">
              ...
              <div
                className={
                  get(providerDYDX, 'address') === activeProviderUsdc ? 'stat best' : 'stat'
                }
              >
                <span className="name">dYdX</span>
                <span className="number">
