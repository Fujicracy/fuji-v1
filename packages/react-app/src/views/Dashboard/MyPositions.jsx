...
function MyPositions({ contracts, address, }) {
  ...
  const debtBalanceDai = useContractReader(
    contracts,
    "FujiERC1155",
    "balanceOf",
    [address, getBorrowId("DAI")]
  );
  ...
  const hasDaiPosition = positionDai.collateralBalance &&
              Number(formatUnits(positionDai.collateralBalance)) > 0;

  const debtBalanceUsdc = useContractReader(
    contracts,
    "FujiERC1155",
    "balanceOf",
    [address, getBorrowId("USDC")]
  );
  ...
  const hasUsdcPosition = positionUsdc.collateralBalance &&
              Number(formatUnits(positionUsdc.collateralBalance)) > 0;
